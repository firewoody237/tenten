package com.example.tenten.integrated.common.resultcode
...
enum class ResultCode(val code: Int, val msg: String) {
    ...
    //7000 컨텐츠 제공자
    ERROR_CONTENT_PROVIDER_NOT_EXISTS(7001, "존재하지 않는 컨텐츠 제공자 입니다."),
    ERROR_CONTENT_PROVIDER_ALREADY_EXISTS(8001, "이미 존재하는 컨텐츠 제공자 입니다."),

    //8000
    ERROR_ITEM_NOT_EXISTS(8001, "존재하지 않는 상품 입니다."),
    ERROR_ITEM_ALREADY_EXISTS(8002, "이미 존재하는 상품 입니다."),
    ERROR_CREATOR_NOT_MATCH(8003, "게시자가 일치하지 않습니다."),
